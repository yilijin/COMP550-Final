...
class Challenge:
    def __init__(self, logger, port, data_path, output_dir, number_of_agents = 2, max_frames = 3000, new_setting = True, screen_size = 1024, data_prefix = 'dataset/nips_dataset/', gt_mask = True):
